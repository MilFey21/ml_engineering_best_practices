...
**Реализация:**
- Использование класса `ClearMLExperiment` для управления экспериментами
- Автоматическое создание задач при запуске обучения
- Логирование всех параметров, метрик и артефактов
...
1. **Трекинг экспериментов**: Автоматическое логирование через `ClearMLExperiment`
...
Использование `ClearMLExperiment` как контекстного менеджера обеспечивает:
- Автоматическое создание и закрытие задач
- Обработку ошибок
